...
export class VerticalComponent implements OnInit {
  ...
  constructor(private eventService: EventService, private router: Router, private activatedRoute: ActivatedRoute, private authService:AuthenticationService) { }

  ngOnInit(): void {
    console.log("vertical Component")
  ...
  private handlePreloader(route: any) {
    if (route !== '/disabled-route' && (document.getElementById("preloader") as HTMLElement)) {
      (document.getElementById("preloader") as HTMLElement).style.opacity = "1";
      (document.getElementById("preloader") as HTMLElement).style.visibility = "";
      setTimeout(() => {
        (document.getElementById("preloader") as HTMLElement).style.opacity = "0";
      ...
      if((document.getElementById("preloader") as HTMLElement)) {
        (document.getElementById("preloader") as HTMLElement).style.opacity = "0";
        (document.getElementById("preloader") as HTMLElement).style.visibility = "hidden";
      }
    }
