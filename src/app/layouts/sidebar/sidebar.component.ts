...
export class SidebarComponent implements OnInit {
  ...
  constructor(private router: Router, public translate: TranslateService, 
    private Aut:AuthenticationService, private _apihandler:ApihandlerService) {
  ...
  ngOnInit(): void {
    // Menu Items
    // this.menuItems = MENU;
    this._apihandler.GetItem(`${GlobalComponent.BASE_API}/Account/GetUserPages`).subscribe({
      next:(response) => {
        this.menuItems = response.returnObject;
      }
    });
    this.allPermissions = this.Aut.permissions.value;
    console.log(this.allPermissions)
    this.allPageNames = this.allPermissions.map((item:any) => item.PageName);
